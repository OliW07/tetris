...
class Piece{
    ...
    rotate(pysudo=false){
        ...
        if(this.row+this.arr.length > 11) reverting = true
        else game.drawPiece(this,pysudo)
        ...
        for(let i = 0; i<this.squareLocs.length;i++){
            ...
            if(boardWithoutFallingPiece[this.squareLocs[i][0]][this.squareLocs[i][1]] != 0 ||this.squareLocs[0][i] >11){
